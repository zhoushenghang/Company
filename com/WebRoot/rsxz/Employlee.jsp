...
<body class="mian_bj">
	<div class="mian_top_01">
		...
		<div class="mian_b">
			<div class="mian_b1">
				<a href="AddEmploylee.jsp" title="添加">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr id="search" style="display: none;">
					<td colspan="8"
						...
						<select>
							...
							<option>软装部
							<option>人事部</select>&nbsp;<select><option>状态
							<option>在职
							<option>离职</select>&nbsp; <input name="" type="text"
						value="工号、姓名、职位、手机" class="input_03">&nbsp;<input name=""
						type="text" value="起始日期" class="input_03">&nbsp;-&nbsp;<input
						name="" type="text" value="结束日期" class="input_03">
					</td>
				...
				<tr>
					...
					<td width="5%" class="mian_b_icon_01"><a
						href="updateEmploylee.jsp">编辑</a></td>
					<td width="5%" class="mian_b_icon_02"><a
						href="Employleeshow.jsp">查看</a></td>
				</tr>
				<tr>
					<td width="3%" class="mian_b_bg_lm">&nbsp;</td>
					<td width="10%" class="mian_b_bg_lm"><span></span>工号</td>
					<td width="5%" class="mian_b_bg_lm"><span></span>员工名称</td>
					<td width="10%" class="mian_b_bg_lm"><span></span>性别</td>
					<td width="10%" class="mian_b_bg_lm"><span></span>员工职位</td>
					<td width="10%" class="mian_b_bg_lm"><span></span>手机</td>
					<td width="10%" class="mian_b_bg_lm"><span></span>所属部门</td>
					<td width="10%" class="mian_b_bg_lm"><span></span>入职时间</td>
