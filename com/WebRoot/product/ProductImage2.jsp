	...
	<div class="mian_top_01">
		...
		<div class="mian_b">
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<td valign="top">
						<table width="100%" border="0" cellpadding="4" cellspacing="0">
							<tr>
								<td align="left">
									<table class="product_image" width="110px" align="center"
										cellpadding="0" cellspacing="0">
										<tr>
											<td align="center"><img src="..\images\lb_pic_03.jpg"></td>
										</tr>
										<tr>
											<td align="center">选择：<input type="checkbox"></td>
										</tr>
									</table>
								</td>
								<td align="left">
				...
				<tr>
					<td>&nbsp;</td>
					<td><input type="checkbox">全选&nbsp;&nbsp; <a href="#"><img
							src="..\images\btn_shoucang.jpg"></a>&nbsp;&nbsp;&nbsp;</td>
				</tr>
				<tr>
					<td colspan="2"></td>
				</tr>
