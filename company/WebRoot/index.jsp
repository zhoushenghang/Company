...
<script language="javascript" type="text/javascript">
	...
	function srcchange(id) {
		if (id == "hr1") {
			document.getElementById("mainFrame").src = "EmpList.jsp";
			...
			document.getElementById("mainFrame").src = "DeptList.jsp";
	...
	function changeIcon(id) {
		if (id == "HR") {
			...
			ocument.getElementById("dTitle").innerHTML = "<img src='images/itemdangan.jpg' alt='' style='margin-top:5px'/>";
			document.getElementById("dTitle").style.display = "none";
		...
		<tr>
				...
				<div class="side" style="position: absolute;">
					<ul id="nav">
						<li class="y_css" id="xx1" onmouseover="show(1)"
							onmouseout="hidden1(1)"><a href="EmpList.jsp"
						...
						<li class="y_css" id="xx3"><a
							href="DeptList.jsp" target="mainFrame"
							onclick="changeIcon('Department')"
						...
						<li class="y_css" id="xx9"><a
							href="ProductList.jsp" target="mainFrame"
			...
			<td width="1215" valign="top">
				...
				<div style="text-align: right; margin-right: 15px; float: right">
					...
					src="notice/NoticeSee.jsp"></iframe>
			</td>
