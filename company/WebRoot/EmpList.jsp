		...
		<div class="mian_b">
			...
			<div id="searchCarForm">
				...
				<div style="padding: 0 0 0 6px">
					<input class="easyui-textbox" id="realname" size="6">  <input
	...
	<script type="text/javascript">
		$(function() {
			car_obj = {
				...
				showEdit : function(state) {
					...
					if (state == 'add') {
						...
						if (rows.length == 1) {
							url = "employeeController_findById?empno=" + rows[0].empno;
						} else {
			...
			$("#carDataGrid").datagrid({
				url : "employeeController_list.html",
				title : '员工列表',
				fitColumns : true,
				striped : true,
				rownumbers : true,
